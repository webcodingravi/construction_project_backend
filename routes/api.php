...
Route::get('single-service/{slug}',[FrontServiceController::class,'singleService']);

// front project routes
Route::get('get-projects',[FrontProjectController::class,'index']);
Route::get('get-latest-projects',[FrontProjectController::class,'latestProjects']);
Route::get('single-project/{slug}',[FrontProjectController::class,'singleProject']);



// front articles routes
...
Route::group(['middleware' => ['auth:sanctum']],function(){
    ...
    Route::get('user-info',[DashboardController::class,'userInfo']);
    Route::post('profile-pic',[DashboardController::class,'ProfilePic']);
